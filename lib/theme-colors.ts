/**
 * Централизованная палитра цветов для светлой и темной темы
 * Измените цвета здесь, и они применятся везде в приложении
 */
...
/**
 * Генерирует CSS переменные из палитры цветов
 */
